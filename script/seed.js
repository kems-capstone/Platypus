...
//   Playlist.create({: Date.now(),isCart: true, userId: 1}),
//   Playlist.create({: Date.now(),isCart: false, userId: 2}),
//   Playlist.create({: Date.now(),isCart: true, userId: 2}),
//   Playlist.create({: Date.now(),isCart: false, userId: 1}),
// ])
